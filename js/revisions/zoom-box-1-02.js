...
(function($){
    ...
    function animatePosition(objects, settings)
    {
        ...
        var max_nwidth = (zbimg_width == zbobj_width) ? 0 : -(zbimg_width-zbobj_width);
        if (targetleft >= 0) targetleft = 0;
        else if (targetleft < max_nwidth) targetleft = max_nwidth;

        var max_nheight = (zbimg_height == zbobj_height) ? 0 : -(zbimg_height-zbobj_height);
    ...
    function create(settings)
    {
        ...
        var imgsrc = (typeof settings.imageSource == "string") ? settings.imageSource : '';
        ...
        if (imgsrc && objects.relativeHolder.length && settings.naturalImgWidth != 0 && settings.naturalImgHeight != 0)
        {
